...
def main(script_args, training_args, model_args):
    ...
    train_dataset = train_dataset.map(make_conversation_from_jsonl, num_proc=8)
    val_dataset = val_dataset.map(make_conversation_from_jsonl, num_proc=8)
